...
## Objetivo
Desarrollar el juego del ahorcado aplicando lógica de programación, estructuras condicionales y repetitivas.
...
3. Ejecutar:
   ```bash
   python src/main.py
"El programa fue probrado y funciona correctamente."
